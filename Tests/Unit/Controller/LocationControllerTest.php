...
{
    /**
     * @var \Rintisch\CourseScheduler\Controller\LocationController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Rintisch\CourseScheduler\Controller\LocationController::class)
